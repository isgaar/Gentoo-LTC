...
shellcheck -s bash ./contrib/kde/orizaba/import_kde.sh
shellcheck -s bash ./contrib/kde/orizaba/first_login.sh
...
shellcheck -s bash ./tests/validate-kde-profile.sh
